...
import ConstantsChat.Constants;
import Utils.ChatManagerUtils;
import Utils.sessionAtt;
import clasinEx.chat.SingleChatEnty;
...
public class ChatServety extends HttpServlet {
    private void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {

        response.setContentType("application/json");
        chatManager chatManager = ChatManagerUtils.getChatManager(getServletContext());
        HttpSession session = request.getSession();
        sessionAtt Att = (sessionAtt) session.getAttribute("Username");
        String username = Att.getUsername();
        if (username == null) {
         ...
         */
        String chatVersionString =request.getParameter(Constants.CHAT_VERSION_PARAMETER);
        int chatVersion=Integer.parseInt(chatVersionString);
        ...
        List<SingleChatEnty> chatEntries;
    ...
    private static class ChatAndVersion {
        ...
        final private List<SingleChatEnty> entries;
        final private int version;

        public ChatAndVersion(List<SingleChatEnty> entries, int version) {
